...
public class ManachersAlgo {
    public static void main(String[] args) {
        System.out.println(manachers("ABCAB")); // Output length
        System.out.println(longestPalindrome("ABCAB")); // Actual substring
    }
    ...
    static int manachers(String str) {
        ...
        schar[0] = '@'; // starting sentinel
        schar[n - 1] = '&'; // ending sentinel
        int t = 1;
